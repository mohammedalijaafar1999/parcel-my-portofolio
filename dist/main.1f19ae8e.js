...
},{}],"../javascript/barbraTransitions.js":[function(require,module,exports) {
"use strict";
...
},{"gsap":"../../node_modules/gsap/index.js","@barba/core":"../../node_modules/@barba/core/dist/barba.umd.js"}],"../javascript/navbar/utils.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.distMetric = exports.closestEdge = void 0;
// Detect Closest Edge
// from https://codepen.io/johnstew/pen/zxYJZP?editors=0010
var closestEdge = exports.closestEdge = function closestEdge(x, y, w, h) {
...
// Distance Formula
// from https://codepen.io/johnstew/pen/zxYJZP?editors=0010
var distMetric = exports.distMetric = function distMetric(x, y, x2, y2) {
  var xDiff = x - x2;
  var yDiff = y - y2;
  return xDiff * xDiff + yDiff * yDiff;
};
},{}],"../javascript/navbar/menuItem.js":[function(require,module,exports) {
"use strict";
...
var MenuItem = exports.MenuItem = /*#__PURE__*/function () {
  ...
  _createClass(MenuItem, [{
    ...
    value: function initEvents() {
      var _this = this;
      this.onMouseEnterFn = function (ev) {
        return _this.mouseEnter(ev);
      };
      this.DOM.link.addEventListener("mouseenter", this.onMouseEnterFn);
      this.onMouseLeaveFn = function (ev) {
        return _this.mouseLeave(ev);
      };
    ...
    value: function mouseEnter(ev) {
      ...
      var edge = this.findClosestEdge(ev);
    ...
    key: "findClosestEdge",
    value: function findClosestEdge(ev) {
      var x = ev.pageX - this.DOM.el.offsetLeft;
      var y = ev.pageY - this.DOM.el.offsetTop;
      return (0, _utils.closestEdge)(x, y, this.DOM.el.clientWidth, this.DOM.el.clientHeight);
    }
  }]);
  return MenuItem;
}();
},{"gsap":"../../node_modules/gsap/index.js","./utils":"../javascript/navbar/utils.js"}],"../javascript/navbar/menu.js":[function(require,module,exports) {
"use strict";
...
var Menu = exports.Menu = /*#__PURE__*/function () {
  function Menu(menuDOM, menuBurgerButton) {
    var _this = this;
    ...
    this.DOM.menuItems.forEach(function (menuItem) {
      return _this.menuItems.push(new _menuItem.MenuItem(menuItem));
    });
  }
...
},{"./menuItem":"../javascript/navbar/menuItem.js","gsap":"../../node_modules/gsap/index.js"}],"../javascript/navbar/navbar.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = initMenuLogic;
var _menu = require("./menu");
var _gsap = require("gsap");
function initMenuLogic() {
  var menuDOM = document.querySelector(".menu");
  var menuBurgerButton = document.querySelector("#menu-burger");
  window.menu = new _menu.Menu(menuDOM, menuBurgerButton);
  _gsap.gsap.set(menuDOM, {
    x: "100%"
  });
...
},{"./menu":"../javascript/navbar/menu.js","gsap":"../../node_modules/gsap/index.js"}],"../javascript/MouseCursor.js":[function(require,module,exports) {
"use strict";
...
function initCursorLogic() {
  ...
  var currentX = 0,
    currentY = 0;
  var easeFactor = 0.1;
  var cursorFollower = document.querySelector("#cursor_follower");
  ...
  function animate() {
    ...
    cursorFollower.style.transform = "translate(".concat(currentX, "px, ").concat(currentY, "px)");
...
var _default = exports.default = initCursorLogic;
},{}],"main.js":[function(require,module,exports) {
"use strict";

var _barbraTransitions = _interopRequireDefault(require("../javascript/barbraTransitions"));
var _navbar = _interopRequireDefault(require("../javascript/navbar/navbar"));
var _MouseCursor = _interopRequireDefault(require("../javascript/MouseCursor"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
(0, _barbraTransitions.default)();
(0, _navbar.default)();
(0, _MouseCursor.default)();
},{"../javascript/barbraTransitions":"../javascript/barbraTransitions.js","../javascript/navbar/navbar":"../javascript/navbar/navbar.js","../javascript/MouseCursor":"../javascript/MouseCursor.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
